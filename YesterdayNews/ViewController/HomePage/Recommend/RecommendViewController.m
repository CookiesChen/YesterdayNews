...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [title setText: [self.ViewModel.news[indexPath.row] title]];
    ...
    marginTop += 50 + 10;
    NSInteger count = [self.ViewModel.news[indexPath.row] images].count;
    ...
    [author setText: [self.ViewModel.news[indexPath.row] author]];
    ...
    [comment setText: [NSString stringWithFormat:@"%lu评论", [self.ViewModel.news[indexPath.row] comments].count]];
    ...
    [time setText: [TimeUtils getTimeDifference:[self.ViewModel.news[indexPath.row] time]]];
