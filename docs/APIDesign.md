...
### /api/news/list/_category/_start-_count
...
- Objective-c
  ...
  NSURLSession *session = [NSURLSession sessionWithConfiguration: config
                                                        delegate: (id)self
                                                   delegateQueue: nil];
  NSURL *url = [NSURL URLWithString:@"http://serverIP/api/news/list/society/0-10"];
...
- javascript
  ...
  ```javascript
  axios.get('http://serverIP/api/news/list/society/0-10')
    .then((res) => {
      // code with res
    });
    .catch((err) => {
...
### /api/comment/list/_newsID/_start-count
...
- Objective-c
  ...
  NSURLSession *session = [NSURLSession sessionWithConfiguration: config
                                                        delegate: (id)self
                                                   delegateQueue: nil];
  NSURL *url = [NSURL URLWithString:@"http://serverIP/api/comment/list/0-10"];
...
- javascript
  ...
  ```javascript
  axios.get('http://serverIP/api/comment/list/0-10')
    .then((res) => {
      // code with res
    });
    .catch((err) => {
